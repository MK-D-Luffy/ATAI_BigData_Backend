package com.atai.commonutils.util;
...
public class SendMail {
    ...
    public static String myEmailAccount = "atai2021@126.com";
    public static String myEmailPassword = "JWBVZMVKHUDTCVWY";
    ...
    public static void senEmail(String receiveMailAccount, String senderName, String receiverName,
        ...
        // 3. 创建一封邮件
        MimeMessage message = createMimeMessage(session, myEmailAccount, receiveMailAccount, senderName, receiverName, subject, content);
...
//    }
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail,
                                                String senderName, String receiverName, String subject, String content) throws Exception {
        // 1. 创建一封邮件
